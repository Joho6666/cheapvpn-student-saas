...
- Production startup rejects example/placeholder admin passwords and requires `ADMIN_ENCRYPTION_KEY` to be a non-placeholder secret of at least 32 characters. Webhook mode applies the same minimum to its signing secret.
